...
$this->title = Yii::t('kid/responsibility', 'Responsibilities');
...
<div class="box box-default">
    ...
    <div class="box-header">
        <div class="box-tools pull-left">
            <?= Html::a('<i class="fa fa-plus"></i> ' . Yii::t('kid/responsibility', 'New responsibility'), ['create'], ['class' => 'btn btn-success']) ?>
        </div>
    </div>
